class Grid {
  ...
  createControlButton() {
    ...
    controlsButton.style("background-color", "rgba(255, 255, 255, 0.4)");
  ...
  applyOrientationStyles(isVertical) {
    if (isVertical) {
      ...
      this.ctrlBtn.style("top", "0%");
      // this.ctrlBtn.style("left", "auto");
      // this.ctrlBtn.style("right", "10px");
      this.ctrlBtn.style("transform", "translateY(-15%) translateX(1130%) ");
